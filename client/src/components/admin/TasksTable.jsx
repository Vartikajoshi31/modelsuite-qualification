...
const getAvatarGradient = (name = '') =>
  AVATAR_COLORS[
    name ? name.charCodeAt(0) % AVATAR_COLORS.length : 0
  ];
...
const TasksTable = ({ tasks, onEdit, onRefresh }) => {
  ...
  return (
    /*
      Issue #18 fix:
      This wrapper owns the horizontal scrolling.
      The full page will no longer need to expand with the table.
    */
    <div
        ...
        <tbody>
          {tasks.map((task, i) => (
            ...
            >
              ...
              >
                <span
                  className={`inline-block px-2.5 py-[3px] rounded-full text-[11.5px] font-medium ${
